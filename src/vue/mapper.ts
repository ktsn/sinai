...
type State<ST extends VueStore<any, any, any, any>> = ST extends VueStore<
  infer S,
  any,
  any,
  any
>
  ? S
  : never
type Getters<ST extends VueStore<any, any, any, any>> = ST extends VueStore<
  any,
  infer G,
  any,
  any
>
  ? G
  : never
type Mutations<ST extends VueStore<any, any, any, any>> = ST extends VueStore<
  any,
  any,
  infer M,
  any
>
  ? M
  : never
type Actions<ST extends VueStore<any, any, any, any>> = ST extends VueStore<
  any,
  any,
  any,
  infer A
...
export class VueMapper<S, G, M, A> {
  ...
  module<T extends Module<S, G, M, A>>(
    module: T,
  ): VueMapper<S[T], G[T], M[T], A[T]>
...
export function createMapper<
  ST extends VueStore<{}, BG0, BM0, BA0>,
>(): VueMapper<State<ST>, Getters<ST>, Mutations<ST>, Actions<ST>> {
